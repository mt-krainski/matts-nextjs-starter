...
import { ThemeToggleText } from "./component";
import { ThemeProvider } from "../ThemeProvider/component";
import { expect, userEvent, within } from "storybook/test";
import { withDropdown } from "@/test-utils/storybook";

const meta: Meta<typeof ThemeToggleText> = {
  title: "Components/ThemeToggleText",
  component: ThemeToggleText,
  parameters: {
    layout: "centered",
  },
  tags: ["autodocs"],
...
export default meta;
type Story = StoryObj<typeof ThemeToggleText>;
